...
int main() 
{
	// crate temp files using - tmpfile, mktemp , tmpnam , and tempnam
        // FILE *file1 = tmpfile();
	char ch[] = "anything we can write";
	write_temp_file(ch, strlen(ch));


}

//GNU/Linux provides several other functions for generating temporary files and tem-
//porary filenames, including mktemp , tmpnam , and tempnam .
